...
def create_registry(args) -> "SolverRegistry":
    ...
    aggregator_url = args.aggregator_url or os.getenv("AGGREGATOR_URL", "https://aggregator.ntfork.com")
...
Environment Variables:
  AGGREGATOR_URL    Aggregator API URL (default: https://aggregator.ntfork.com)
