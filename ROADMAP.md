...
compete for champion. **The champion miner earns a flat 20% of the miner
emission pool**, with the remaining 80% routed to the subnet owner — a fixed
...
`Weight Setting` `Flat 20% Champion Split` `Independent Miners` `Independent Validators`
